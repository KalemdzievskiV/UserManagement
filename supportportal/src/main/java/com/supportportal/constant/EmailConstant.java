...
public class EmailConstant {
    ...
    public static final String USERNAME = "vladakal12@gmail.com";
    public static final String PASSWORD = "yjcg atfo xlpc kbuz";
    public static final String FROM_EMAIL = "vladakal12@gmail.com";
